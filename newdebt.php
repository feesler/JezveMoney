...
*/
		...
		html_op("<div>");
			html_op("<div class=\"curr_container\">");
				html("<div class=\"btn rcurr_btn\" type=\"button\"><div id=\"amountsign\">".$debtAcc["sign"]."</div></div>");
	...
	html_op("<div id=\"result_balance_dest\" class=\"non_float\" style=\"display: none;\">");
		...
		html_op("<div>");
			html("<div class=\"right_float\"><span id=\"res_currsign_d\" class=\"curr_sign\">".$debtAcc["sign"]."</span></div>");
			html_op("<div class=\"stretch_input trans_input\">");
				html_op("<div>");
