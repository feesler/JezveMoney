                            ...
                            <div class="header-actions">
                                ...
                                <div class="actions-menu">
                                    ...
                                    <div id="actionsList" class="actions-menu-list" hidden>
                                        ...
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "selectModeBtn"],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Select",
                                            "icon" => "select"
                                        ]) ?>
                                        <div id="separator2" class="actions-menu-list__separator"></div>
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "selectAllBtn"],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Select all",
                                            "icon" => null,
                                        ]) ?>
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "deselectAllBtn"],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Clear selection",
                                            "icon" => null,
                                        ]) ?>
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "enableSelectedBtn"],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Enable selected",
                                            "icon" => null,
                                        ]) ?>
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "disableSelectedBtn"],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Disable selected",
                                            "icon" => null,
                                        ]) ?>
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "deleteSelectedBtn"],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Delete selected",
                                            "icon" => "del",
                                        ]) ?>
                                        <?= IconButton::render([
                                            "attributes" => ["id" => "deleteAllBtn", "disabled" => true],
                                            "classNames" => "action-iconbutton",
                                            "title" => "Delete all",
                                            "icon" => "del",
                                        ]) ?>
                                        <div id="separator3" class="actions-menu-list__separator"></div>
