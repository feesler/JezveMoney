...
<div id="readTrForm" class="request-data-form">
    ...
    <div class="std_margin">
        ...
        <input id="read_trans_id" class="input stretch-input" type="text">
    </div>
    <div class="form-controls">
...
<div id="createTrForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/transaction/create" method="post">
        <div class="std_margin">
            ...
            <input id="create_trans_type" class="input stretch-input" name="type" type="text">
        </div>
        <div class="std_margin">
            <label for="create_trans_src_id">Source account</label>
            <input id="create_trans_src_id" class="input stretch-input" name="src_id" type="text">
        </div>
        <div class="std_margin">
            <label for="create_trans_dest_id">Destination account</label>
            <input id="create_trans_dest_id" class="input stretch-input" name="dest_id" type="text">
        </div>
        <div class="std_margin">
            <label for="create_trans_src_amount">Source amount</label>
            <input id="create_trans_src_amount" class="input stretch-input" name="src_amount" type="text">
        </div>
        <div class="std_margin">
            <label for="create_trans_dest_amount">Destination amount</label>
            <input id="create_trans_dest_amount" class="input stretch-input" name="dest_amount" type="text">
        </div>

        <div class="std_margin">
            <label for="create_trans_src_curr">Source currency</label>
            <input id="create_trans_src_curr" class="input stretch-input" name="src_curr" type="text">
        </div>
        <div class="std_margin">
            <label for="create_trans_dest_curr">Destination currency</label>
            <input id="create_trans_dest_curr" class="input stretch-input" name="dest_curr" type="text">
        </div>

        <div class="std_margin">
            <label for="create_trans_date">Date</label>
            <input id="create_trans_date" class="input stretch-input" name="date" type="text">
        </div>
        ...
        <div class="std_margin">
            ...
            <input id="create_trans_comment" class="input stretch-input" name="comment" type="text">
        </div>
...
<div id="createDebtForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/transaction/create" method="post">
        ...
        <div class="std_margin">
            ...
            <input id="create_debt_person_id" class="input stretch-input" name="person_id" type="text">
        </div>
        <div class="std_margin">
            <label for="create_debt_acc_id">Account id</label>
            <input id="create_debt_acc_id" class="input stretch-input" name="acc_id" type="text">
        </div>
        <div class="std_margin">
            <label for="create_debt_op">Debt operation (1 or 2)</label>
            <input id="create_debt_op" class="input stretch-input" name="op" type="text">
        </div>

        <div class="std_margin">
            <label for="create_debt_src_amount">Source amount</label>
            <input id="create_debt_src_amount" class="input stretch-input" name="src_amount" type="text">
        </div>
        <div class="std_margin">
            <label for="create_debt_dest_amount">Destination amount</label>
            <input id="create_debt_dest_amount" class="input stretch-input" name="dest_amount" type="text">
        </div>

        <div class="std_margin">
            <label for="create_debt_src_curr">Source currency</label>
            <input id="create_debt_src_curr" class="input stretch-input" name="src_curr" type="text">
        </div>
        <div class="std_margin">
            <label for="create_debt_dest_curr">Destination currency</label>
            <input id="create_debt_dest_curr" class="input stretch-input" name="dest_curr" type="text">
        </div>

        <div class="std_margin">
            <label for="create_debt_date">Date</label>
            <input id="create_debt_date" class="input stretch-input" name="date" type="text">
        </div>

        <div class="std_margin">
            <label for="create_debt_category_id">Category</label>
            <input id="create_debt_category_id" class="input stretch-input" name="category_id" type="text">
        </div>

        <div class="std_margin">
            <label for="create_debt_comment">Comment</label>
            <input id="create_debt_comment" class="input stretch-input" name="comment" type="text">
        </div>
...
<div id="updateTrForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/transaction/update" method="post">
        <div class="std_margin">
            ...
            <input id="update_trans_id" class="input stretch-input" name="id" type="text">
        </div>
        <div class="std_margin">
            <label for="update_trans_type">Type (1-3)</label>
            <input id="update_trans_type" class="input stretch-input" name="type" type="text">
        </div>

        <div class="std_margin">
            <label for="update_trans_src_id">Source account</label>
            <input id="update_trans_src_id" class="input stretch-input" name="src_id" type="text">
        </div>
        <div class="std_margin">
            <label for="update_trans_dest_id">Destination account</label>
            <input id="update_trans_dest_id" class="input stretch-input" name="dest_id" type="text">
        </div>

        <div class="std_margin">
            <label for="update_trans_src_amount">Source amount</label>
            <input id="update_trans_src_amount" class="input stretch-input" name="src_amount" type="text">
        </div>
        <div class="std_margin">
            <label for="update_trans_dest_amount">Destination amount</label>
            <input id="update_trans_dest_amount" class="input stretch-input" name="dest_amount" type="text">
        </div>

        <div class="std_margin">
            <label for="update_trans_src_curr">Source currency</label>
            <input id="update_trans_src_curr" class="input stretch-input" name="src_curr" type="text">
        </div>
        <div class="std_margin">
            <label for="update_trans_dest_curr">Destination currency</label>
            <input id="update_trans_dest_curr" class="input stretch-input" name="dest_curr" type="text">
        </div>

        <div class="std_margin">
            <label for="update_trans_date">Date</label>
            <input id="update_trans_date" class="input stretch-input" name="date" type="text">
        </div>

        <div class="std_margin">
            <label for="update_trans_category_id">Category</label>
            <input id="update_trans_category_id" class="input stretch-input" name="category_id" type="text">
        </div>

        <div class="std_margin">
            <label for="update_trans_comment">Comment</label>
            <input id="update_trans_comment" class="input stretch-input" name="comment" type="text">
        </div>
...
<div id="updateDebtForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/transaction/update" method="post">
        ...
        <div class="std_margin">
            ...
            <input id="update_debt_id" class="input stretch-input" name="id" type="text">
        </div>

        <div class="std_margin">
            <label for="update_debt_person_id">Person id</label>
            <input id="update_debt_person_id" class="input stretch-input" name="person_id" type="text">
        </div>
        <div class="std_margin">
            <label for="update_debt_acc_id">Account id</label>
            <input id="update_debt_acc_id" class="input stretch-input" name="acc_id" type="text">
        </div>
        <div class="std_margin">
            <label for="update_debt_op">Debt operation (1 or 2)</label>
            <input id="update_debt_op" class="input stretch-input" name="op" type="text">
        </div>

        <div class="std_margin">
            <label for="update_debt_src_amount">Source amount</label>
            <input id="update_debt_src_amount" class="input stretch-input" name="src_amount" type="text">
        </div>
        <div class="std_margin">
            <label for="update_debt_dest_amount">Destination amount</label>
            <input id="update_debt_dest_amount" class="input stretch-input" name="dest_amount" type="text">
        </div>

        <div class="std_margin">
            <label for="update_debt_src_curr">Source currency</label>
            <input id="update_debt_src_curr" class="input stretch-input" name="src_curr" type="text">
        </div>
        <div class="std_margin">
            <label for="update_debt_dest_curr">Destination currency</label>
            <input id="update_debt_dest_curr" class="input stretch-input" name="dest_curr" type="text">
        </div>

        <div class="std_margin">
            <label for="update_debt_date">Date</label>
            <input id="update_debt_date" class="input stretch-input" name="date" type="text">
        </div>

        <div class="std_margin">
            <label for="update_debt_category_id">Category</label>
            <input id="update_debt_category_id" class="input stretch-input" name="category_id" type="text">
        </div>

        <div class="std_margin">
            <label for="update_debt_comment">Comment</label>
            <input id="update_debt_comment" class="input stretch-input" name="comment" type="text">
        </div>
...
<div id="setTrCategoryForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/transaction/setCategory" method="post">
        <div class="std_margin">
            ...
            <input id="trans_setCategory_id" class="input stretch-input" name="id" type="text">
        </div>

        <div class="std_margin">
            <label for="trans_setCategory_category_id">Category id</label>
            <input id="trans_setCategory_category_id" class="input stretch-input" name="category_id" type="text">
        </div>
...
<div id="setTrPosForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/transaction/setpos" method="post">
        <div class="std_margin">
            ...
            <input id="trans_pos_id" class="input stretch-input" name="id" type="text">
        </div>

        <div class="std_margin">
            <label for="trans_pos_pos">Position</label>
            <input id="trans_pos_pos" class="input stretch-input" name="pos" type="text">
        </div>
    ...
    <form action="<?= BASEURL ?>api/transaction/statistics" method="post">
        <div class="std_margin">
            <div class="std_margin">
                ...
                <input id="statistics_type" class="input stretch-input" name="type" type="text">
            </div>
            <div class="std_margin">
            ...
            <div class="std_margin">
                ...
                <input id="statistics_cat" class="input stretch-input" name="category_id" type="text">
            </div>
            <div class="std_margin">
