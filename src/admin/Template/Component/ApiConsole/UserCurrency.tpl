<div id="listUserCurrencyForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/usercurrency/list" method="get">
        <div class="std_margin">
            ...
            <input class="input stretch-input" name="curr_id" type="text" autocomplete="off" autocapitalize="none" spellcheck="false" value="" disabled hidden>
        </div>
...
<div id="readUserCurrencyForm" class="request-data-form">
    ...
    <div class="std_margin">
        ...
        <input id="read_user_currency_id" class="input stretch-input" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
    </div>
    <div class="form-controls">
...
<div id="createUserCurrencyForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/usercurrency/create" method="post">
        <div class="std_margin">
            ...
            <input id="create_user_currency_curr_id" class="input stretch-input" name="curr_id" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label for="create_user_currency_flags">Flags</label>
            <input id="create_user_currency_flags" class="input stretch-input" name="flags" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label class="checkbox">
...
<div id="updateUserCurrencyForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/usercurrency/update" method="post">
        <div class="std_margin">
            ...
            <input id="update_user_currency_id" class="input stretch-input" name="id" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label for="update_user_currency_curr_id">Currency id</label>
            <input id="update_user_currency_curr_id" class="input stretch-input" name="curr_id" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label for="update_user_currency_flags">Flags</label>
            <input id="update_user_currency_flags" class="input stretch-input" name="flags" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label class="checkbox">
                <input type="checkbox" data-target="returnState">
...
<div id="delUserCurrencyForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/usercurrency/delete" method="post">
        <div class="std_margin">
            ...
            <input id="delUserCurrency" class="input stretch-input" name="id" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label class="checkbox">
                <input type="checkbox" data-target="returnState">
...
<div id="setUserCurrencyPosForm" class="request-data-form">
    ...
    <form action="<?= BASEURL ?>api/usercurrency/setpos" method="post">
        <div class="std_margin">
            ...
            <input id="user_currency_pos_id" class="input stretch-input" name="id" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label for="user_currency_pos_pos">Position</label>
            <input id="user_currency_pos_pos" class="input stretch-input" name="pos" type="text" autocomplete="off" autocapitalize="none" spellcheck="false">
        </div>
        <div class="std_margin">
            <label class="checkbox">
                <input type="checkbox" data-target="returnState">
