...
const createMultipleWithSchedule = async () => {
    ...
    const data = [{
        data: [{
            ...
            category_id: FOOD_CATEGORY,
            name: 'Repeat Multiple Expense 1',
            interval_type: 3,
            interval_step: 1,
            interval_offset: 5,
            ...
            name: 'Repeat Multiple Transfer 1',
            interval_type: 1,
            interval_step: 1,
            interval_offset: 0,
            start_date: App.datesSec.weekAgo,
